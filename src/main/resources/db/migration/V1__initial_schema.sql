...
CREATE TABLE IF NOT EXISTS smart_categories (
    ...
    CONSTRAINT fk_smart_categories_user FOREIGN KEY (user_id) REFERENCES users(id)
);
...
CREATE TABLE IF NOT EXISTS scheduled_payments (
    ...
    CONSTRAINT fk_scheduled_payments_user FOREIGN KEY (user_id) REFERENCES users(id),
